...
-- {{{ Main
local theme = {}
theme.wallpaper = themes_path .. "alduin/background.jpg"
-- }}}
...
-- {{{ Colors
theme.fg_normal  = "#d7d7af"
theme.fg_focus   = "#af875f"
theme.fg_urgent  = "#af5f5f"
theme.bg_normal  = "#1c1c1c" 
theme.bg_focus   = "#262626"
theme.bg_urgent  = "#875f5f"
...
-- {{{ Icons
-- {{{ Taglist
theme.taglist_squares_sel   = themes_path .. "alduin/taglist/squarefz.png"
theme.taglist_squares_unsel = themes_path .. "alduin/taglist/squarez.png"
--theme.taglist_squares_resize = "false"
-- }}}

-- {{{ Misc
theme.awesome_icon           = themes_path .. "alduin/awesome-icon.png"
